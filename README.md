...
**[watt-bench](https://github.com/jadoont/watt-bench)** — Discrete-event simulation benchmark treating rack-level power budgets as hard constraints and tokens-per-watt as a first-class metric. On real Azure traces: 1,000+ thermal throttle events for latency-greedy scheduling, zero for power-aware.

---

[LinkedIn](https://linkedin.com/in/jadoont) · [X](https://x.com/tabs.kj)
